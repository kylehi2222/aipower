        ...
        if(wpaicgFormsShortcode && wpaicgFormsShortcode.length){
            ...
            var handleFeedbackButtonClick = function(e) {
                ...
                jQuery('#wpaicg_submitFeedback').off('click').on('click', function() {
                    ...
                    xhttp.open('POST', wpaicgFormData.ajax);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send('action=wpaicg_save_feedback&formID=' + formID + '&feedback=' + feedbackType + '&comment=' + encodeURIComponent(comment) + '&nonce=' + wpaicgFormData.ajax_nonce + '&formname=' + wpaicgFormData.name + '&sourceID=' + wpaicgFormData.sourceID + '&response=' + responseText + '&eventID=' + eventID);
