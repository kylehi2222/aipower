        ...
        public function wpaicg_update_prompt()
        {
            ...
            if(
                ...
                foreach($prompt_fields as $prompt_field){
                    ...
                    elseif(in_array($prompt_field,array('bgcolor','header','dans','ddraft','dclear','dnotice','ddownload','copy_button')) && (!isset($_POST[$prompt_field]) || empty($_POST[$prompt_field]))){
