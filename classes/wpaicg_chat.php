                ...
                if (!empty($wpaicg_message)) {
                    ...
                    if(!empty($wpaicg_chat_addition_text)){
                        ...
                        if (strpos($wpaicg_chat_addition_text, '[bgc_data_post_flat]') !== false) {
                            // Check if post_id is available in the request
                            if (isset($_REQUEST['post_id']) && !empty($_REQUEST['post_id'])) {
                                $post_id = sanitize_text_field($_REQUEST['post_id']);
                                
                                // Fetch the data directly from the post meta
                                $meta_key = '_bgc_data';
                                $data = get_post_meta($post_id, $meta_key, true);
                                if ($data) {
                                    $bgc_data_post_flat = pretty_print_flat_recursive($data);
                                ...
                                // Handle when no post_id is found in the request
                        ...
                        if (strpos($wpaicg_chat_addition_text, '[post_title]') !== false) {
                                ...
                                if (isset($_REQUEST['post_id']) && !empty($_REQUEST['post_id'])) {
                                    ...
                                    if ($post_title) {
                                        ...
                                        // Handle when no post title is found
